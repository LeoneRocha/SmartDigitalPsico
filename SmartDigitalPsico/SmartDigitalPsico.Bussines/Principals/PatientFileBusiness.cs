...
{
    public class PatientFileBusiness : GenericBussinesEntityBaseSimplev2<PatientFile, AddPatientFileVO, UpdatePatientFileVO, GetPatientFileVO, IPatientFileRepository>, IPatientFileBusiness
