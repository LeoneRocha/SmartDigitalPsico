...
export class UserManagementComponent implements OnInit {
    ...
    newRegister(): void {
        this.router.navigate(['/administrative/usermanagement/usermanagementaction']);
    }
    viewRegister(idRegister: number): void {
        this.router.navigate(['/administrative/usermanagement/usermanagementaction', { modeForm: 'view', id: idRegister }]);
    }
    editRegister(idRegister: number): void {
        this.router.navigate(['/administrative/usermanagement/usermanagementaction', { modeForm: 'edit', id: idRegister }]);
    }
    ...
    retrieveList(): void {
        this.registerService.getAll().subscribe({
            next: (response: any) => {
                ...
                CaptureTologFunc('retrieveList-usermanagement', response);
            },
 ...
 */
    executeDeleteRegister(idRegister: number) {
        this.registerService.delete(idRegister).subscribe({
            next: (response: any) => {
                CaptureTologFunc('executeDeleteRegister-usermanagement', response);
