...
{
    public class GetPatientRecordVOEnricher : ContentResponseEnricher<GetPatientRecordVO>

    {
        private readonly object _lock = new object();
        protected override Task EnrichModel(GetPatientRecordVO content, IUrlHelper urlHelper)
        {
