...
export class PatientHospitalizationinformationComponent implements OnInit {
    public listResult: PatientHospitalizationInformationModel[];
    ...
    newRegister(): void {
        this.router.navigate(['/patient/manage/hospitalizationinformationaction', { parentId: this.parentId }]);
    }
    viewRegister(idRegister: number): void {
        this.router.navigate(['/patient/manage/hospitalizationinformationaction', { modeForm: 'view', parentId: this.parentId, id: idRegister }]);
    }
    editRegister(idRegister: number): void {
        this.router.navigate(['/patient/manage/hospitalizationinformationaction', { modeForm: 'edit', parentId: this.parentId, id: idRegister }]);
    }
    ...
    executeDeleteRegister(idRegister: number) {
        this.registerService.delete(idRegister).subscribe({
            next: (response: any) => {
                ...
                this.listResult = this.removeItemFromList<PatientHospitalizationInformationModel>(this.listResult, idRegister);
