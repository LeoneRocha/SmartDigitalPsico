...
export class PatientMedicationInformationComponent implements OnInit {
    public listResult: PatientMedicationInformationModel[];
    ...
    newRegister(): void {
        this.router.navigate(['/patient/manage/medicationinformationaction', { parentId: this.parentId }]);
    }
    viewRegister(idRegister: number): void {
        this.router.navigate(['/patient/manage/medicationinformationaction', { modeForm: 'view', parentId: this.parentId, id: idRegister }]);
    }
    editRegister(idRegister: number): void {
        this.router.navigate(['/patient/manage/medicationinformationaction', { modeForm: 'edit', parentId: this.parentId, id: idRegister }]);
    }
    ...
    executeDeleteRegister(idRegister: number) {
        this.registerService.delete(idRegister).subscribe({
            next: (response: any) => {
                ...
                this.listResult = this.removeItemFromList<PatientMedicationInformationModel>(this.listResult, idRegister);
