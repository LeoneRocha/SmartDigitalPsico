    ...
    public partial class SmartDigitalPsicoDBMig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2023, 3, 22, 14, 7, 23, 410, DateTimeKind.Local).AddTicks(1579), "Default", true, "", "", "pt-BR", new DateTime(2023, 3, 22, 14, 7, 23, 410, DateTimeKind.Local).AddTicks(1594), new DateTime(2023, 3, 22, 14, 7, 23, 410, DateTimeKind.Local).AddTicks(1593), 1, 0, 0 });

            migrationBuilder.InsertData(
                schema: "dbo",
                table: "ApplicationLanguage",
                columns: new[] { "Id", "CreatedDate", "Description", "Enable", "Language", "LanguageKey", "LanguageValue", "LastAccessDate", "ModifyDate" },
                values: new object[] { 1L, new DateTime(2023, 3, 22, 14, 7, 23, 410, DateTimeKind.Local).AddTicks(1666), "Default", true, "pt-BR", "Default_ptbr", "Padrão", new DateTime(2023, 3, 22, 14, 7, 23, 410, DateTimeKind.Local).AddTicks(1669), new DateTime(2023, 3, 22, 14, 7, 23, 410, DateTimeKind.Local).AddTicks(1668) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, true, new DateTime(2023, 3, 22, 14, 7, 23, 410, DateTimeKind.Local).AddTicks(2140), "admin@sistemas.com", true, null, new DateTime(2023, 3, 22, 14, 7, 23, 410, DateTimeKind.Local).AddTicks(2142), "admin", null, new DateTime(2023, 3, 22, 14, 7, 23, 410, DateTimeKind.Local).AddTicks(2143), "User MOCK ", new byte[] { 56, 25, 3, 101, 125, 187, 16, 80, 6, 106, 134, 66, 159, 221, 208, 24, 142, 8, 250, 131, 118, 179, 29, 9, 208, 144, 232, 214, 114, 192, 154, 45, 76, 29, 163, 108, 210, 221, 193, 236, 158, 245, 245, 207, 174, 148, 219, 217, 184, 68, 238, 207, 207, 202, 115, 121, 217, 13, 237, 179, 54, 12, 230, 181 }, new byte[] { 151, 19, 33, 75, 130, 105, 57, 115, 93, 201, 2, 25, 14, 126, 55, 228, 151, 132, 132, 134, 14, 192, 24, 178, 24, 198, 70, 195, 134, 201, 175, 170, 175, 139, 194, 55, 164, 7, 212, 32, 249, 245, 140, 42, 91, 73, 116, 203, 118, 211, 126, 135, 209, 61, 46, 132, 86, 123, 55, 103, 93, 197, 61, 105, 68, 40, 132, 7, 9, 51, 219, 234, 40, 166, 41, 73, 79, 221, 135, 154, 10, 95, 183, 136, 23, 87, 28, 63, 144, 221, 122, 125, 58, 243, 198, 132, 90, 191, 197, 213, 222, 247, 182, 108, 85, 235, 82, 114, 3, 97, 179, 130, 75, 120, 241, 86, 93, 108, 39, 53, 118, 132, 213, 8, 92, 253, 115, 181 }, null, null, "Admin", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "123456", new DateTime(2023, 3, 22, 14, 7, 23, 410, DateTimeKind.Local).AddTicks(2556), 1L, "medical@sistemas.com", true, new DateTime(2023, 3, 22, 14, 7, 23, 410, DateTimeKind.Local).AddTicks(2558), new DateTime(2023, 3, 22, 14, 7, 23, 410, DateTimeKind.Local).AddTicks(2559), null, "Medical MOCK ", 3L, null, 0, null });
            ...
            migrationBuilder.InsertData(
                ...
                table: "Users",
                columns: new[] { "Id", "Admin", "CreatedDate", "Email", "Enable", "Language", "LastAccessDate", "Login", "MedicalId", "ModifyDate", "Name", "PasswordHash", "PasswordSalt", "Refresh_token", "Refresh_token_expiry_time", "Role", "TimeZone" },
                values: new object[] { 2L, false, new DateTime(2023, 3, 22, 14, 7, 23, 410, DateTimeKind.Local).AddTicks(3125), "doctor@sistemas.com", true, null, new DateTime(2023, 3, 22, 14, 7, 23, 410, DateTimeKind.Local).AddTicks(3127), "doctor", 1L, new DateTime(2023, 3, 22, 14, 7, 23, 410, DateTimeKind.Local).AddTicks(3128), "User Medical", new byte[] { 13, 57, 199, 81, 208, 214, 169, 147, 136, 136, 86, 23, 247, 245, 157, 55, 141, 244, 178, 116, 191, 165, 110, 239, 0, 185, 36, 87, 159, 88, 91, 95, 220, 249, 168, 220, 67, 237, 231, 201, 149, 54, 244, 91, 166, 17, 150, 99, 247, 105, 196, 160, 177, 144, 185, 101, 101, 133, 124, 176, 176, 120, 230, 186 }, new byte[] { 32, 77, 100, 188, 151, 43, 58, 216, 71, 26, 220, 235, 96, 212, 139, 100, 125, 235, 12, 39, 114, 49, 241, 101, 90, 90, 188, 133, 144, 14, 56, 229, 51, 57, 179, 214, 195, 3, 219, 46, 3, 203, 146, 33, 243, 116, 143, 197, 159, 166, 205, 124, 176, 76, 158, 69, 136, 160, 97, 140, 70, 235, 123, 236, 4, 81, 147, 88, 245, 78, 3, 171, 227, 141, 51, 61, 132, 8, 97, 178, 83, 116, 171, 22, 86, 225, 21, 7, 137, 77, 98, 93, 162, 11, 65, 249, 6, 95, 180, 142, 25, 220, 60, 192, 86, 161, 239, 89, 24, 80, 31, 81, 29, 181, 44, 174, 238, 108, 186, 236, 151, 27, 123, 149, 243, 18, 253, 22 }, null, null, "Medical", null });
