...
namespace SmartDigitalPsico.WebAPI.Migrations
{
    ...
    [Migration("20230320135845_SmartDigitalPsicoDBMig002")]
            ...
            modelBuilder.Entity("SmartDigitalPsico.Model.Entity.Domains.Configurations.ApplicationConfigSetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2023, 3, 20, 10, 58, 45, 444, DateTimeKind.Local).AddTicks(8807),
                            Description = "Default",
                            Enable = true,
                            EndPointUrl_Cache = "",
                            EndPointUrl_StorageFiles = "",
                            Language = "pt-BR",
                            LastAccessDate = new DateTime(2023, 3, 20, 10, 58, 45, 444, DateTimeKind.Local).AddTicks(8820),
                            ModifyDate = new DateTime(2023, 3, 20, 10, 58, 45, 444, DateTimeKind.Local).AddTicks(8819),
                            TypeLocationCache = 1,
            ...
            modelBuilder.Entity("SmartDigitalPsico.Model.Entity.Domains.Configurations.ApplicationLanguage", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2023, 3, 20, 10, 58, 45, 444, DateTimeKind.Local).AddTicks(8847),
                            Description = "Default",
                            Enable = true,
                            Language = "pt-BR",
                            LanguageKey = "Default_ptbr",
                            LanguageValue = "Padrão",
                            LastAccessDate = new DateTime(2023, 3, 20, 10, 58, 45, 444, DateTimeKind.Local).AddTicks(8848),
                            ModifyDate = new DateTime(2023, 3, 20, 10, 58, 45, 444, DateTimeKind.Local).AddTicks(8847)
                        });
                });
            ...
            modelBuilder.Entity("SmartDigitalPsico.Model.Entity.Principals.Medical", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 3, 20, 10, 58, 45, 444, DateTimeKind.Local).AddTicks(9497),
                            CreatedUserId = 1L,
                            Email = "medical@sistemas.com",
                            Enable = true,
                            LastAccessDate = new DateTime(2023, 3, 20, 10, 58, 45, 444, DateTimeKind.Local).AddTicks(9498),
                            ModifyDate = new DateTime(2023, 3, 20, 10, 58, 45, 444, DateTimeKind.Local).AddTicks(9498),
                            Name = "Medical MOCK ",
                            OfficeId = 3L,
                            TypeAccreditation = 0,
                            UserId = 2L
            ...
            modelBuilder.Entity("SmartDigitalPsico.Model.Entity.Principals.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Admin = true,
                            CreatedDate = new DateTime(2023, 3, 20, 10, 58, 45, 444, DateTimeKind.Local).AddTicks(9031),
                            Email = "admin@sistemas.com",
                            Enable = true,
                            LastAccessDate = new DateTime(2023, 3, 20, 10, 58, 45, 444, DateTimeKind.Local).AddTicks(9032),
                            Login = "admin",
                            ModifyDate = new DateTime(2023, 3, 20, 10, 58, 45, 444, DateTimeKind.Local).AddTicks(9033),
                            Name = "User MOCK ",
                            PasswordHash = new byte[] { 250, 188, 161, 147, 138, 210, 173, 220, 131, 185, 143, 189, 216, 99, 247, 210, 182, 172, 141, 202, 145, 151, 117, 237, 238, 208, 169, 244, 244, 195, 130, 87, 61, 43, 213, 191, 38, 203, 81, 189, 145, 163, 213, 204, 73, 243, 144, 252, 69, 11, 119, 150, 250, 131, 161, 18, 74, 184, 212, 4, 167, 222, 106, 244 },
                            PasswordSalt = new byte[] { 57, 234, 136, 133, 166, 162, 246, 184, 245, 28, 188, 152, 59, 179, 61, 133, 184, 115, 99, 127, 71, 131, 22, 42, 53, 18, 196, 61, 137, 103, 33, 217, 146, 95, 242, 206, 207, 204, 152, 42, 123, 201, 232, 85, 103, 4, 31, 187, 251, 187, 165, 23, 186, 244, 171, 30, 170, 43, 165, 230, 124, 241, 79, 239, 35, 155, 97, 20, 138, 74, 77, 65, 120, 212, 21, 172, 117, 78, 95, 53, 39, 99, 191, 192, 3, 147, 100, 79, 249, 7, 76, 250, 31, 207, 218, 243, 178, 112, 79, 0, 77, 17, 10, 58, 18, 106, 133, 9, 155, 23, 71, 166, 246, 92, 197, 251, 183, 208, 233, 73, 245, 116, 228, 36, 26, 30, 83, 143 },
                            Role = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            Admin = false,
                            CreatedDate = new DateTime(2023, 3, 20, 10, 58, 45, 444, DateTimeKind.Local).AddTicks(9263),
                            Email = "doctor@sistemas.com",
                            Enable = true,
                            LastAccessDate = new DateTime(2023, 3, 20, 10, 58, 45, 444, DateTimeKind.Local).AddTicks(9264),
                            Login = "doctor",
                            ModifyDate = new DateTime(2023, 3, 20, 10, 58, 45, 444, DateTimeKind.Local).AddTicks(9265),
                            Name = "User Medical",
                            PasswordHash = new byte[] { 102, 164, 179, 149, 141, 64, 203, 50, 17, 136, 187, 183, 139, 229, 188, 142, 190, 142, 74, 185, 182, 198, 24, 172, 80, 233, 35, 165, 117, 105, 194, 118, 162, 174, 241, 92, 225, 53, 136, 80, 29, 56, 186, 255, 15, 160, 223, 235, 112, 89, 95, 232, 25, 115, 54, 146, 13, 140, 43, 27, 25, 157, 104, 48 },
                            PasswordSalt = new byte[] { 48, 109, 42, 98, 63, 220, 222, 148, 44, 16, 186, 159, 115, 111, 42, 23, 232, 234, 137, 101, 39, 217, 83, 48, 198, 178, 7, 104, 56, 71, 103, 70, 102, 134, 216, 215, 59, 96, 130, 57, 202, 181, 187, 240, 92, 85, 146, 26, 22, 241, 202, 246, 165, 66, 61, 14, 55, 28, 143, 159, 46, 97, 155, 255, 19, 155, 221, 61, 222, 140, 253, 184, 255, 120, 243, 186, 76, 88, 9, 102, 225, 29, 102, 7, 137, 204, 116, 238, 226, 97, 157, 158, 171, 51, 159, 255, 239, 238, 115, 27, 190, 172, 83, 159, 103, 201, 117, 101, 12, 127, 60, 250, 17, 68, 45, 190, 107, 84, 80, 236, 40, 110, 51, 112, 28, 83, 233, 167 },
                            Role = "Medical"
                        });
                });
