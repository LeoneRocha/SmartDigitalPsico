...
{
    public class GetSpecialtyVOEnricher : ContentResponseEnricher<GetSpecialtyVO>

    {
        private readonly object _lock = new object();
        protected override Task EnrichModel(GetSpecialtyVO content, IUrlHelper urlHelper)
        {
