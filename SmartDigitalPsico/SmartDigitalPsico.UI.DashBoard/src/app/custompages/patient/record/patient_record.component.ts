...
export class PatientRecordComponent implements OnInit {
    public listResult: PatientRecordModel[];
    ...
    newRegister(): void {
        this.router.navigate(['/patient/manage/recordaction', { parentId: this.parentId }]);
    }
    viewRegister(idRegister: number): void {
        this.router.navigate(['/patient/manage/recordaction', { modeForm: 'view', parentId: this.parentId, id: idRegister }]);
    }
    editRegister(idRegister: number): void {
        this.router.navigate(['/patient/manage/recordaction', { modeForm: 'edit', parentId: this.parentId, id: idRegister }]);
    }
    ...
    executeDeleteRegister(idRegister: number) {
        this.registerService.delete(idRegister).subscribe({
            next: (response: any) => {
                ...
                this.listResult = this.removeItemFromList<PatientRecordModel>(this.listResult, idRegister);
