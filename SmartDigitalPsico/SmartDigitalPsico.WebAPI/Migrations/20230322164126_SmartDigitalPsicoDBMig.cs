        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Medicals_MedicalUserId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2023, 3, 22, 13, 41, 26, 184, DateTimeKind.Local).AddTicks(6582), "Default", true, "", "", "pt-BR", new DateTime(2023, 3, 22, 13, 41, 26, 184, DateTimeKind.Local).AddTicks(6597), new DateTime(2023, 3, 22, 13, 41, 26, 184, DateTimeKind.Local).AddTicks(6596), 1, 0, 0 });

            migrationBuilder.InsertData(
                schema: "dbo",
                table: "ApplicationLanguage",
                columns: new[] { "Id", "CreatedDate", "Description", "Enable", "Language", "LanguageKey", "LanguageValue", "LastAccessDate", "ModifyDate" },
                values: new object[] { 1L, new DateTime(2023, 3, 22, 13, 41, 26, 184, DateTimeKind.Local).AddTicks(6668), "Default", true, "pt-BR", "Default_ptbr", "Padrão", new DateTime(2023, 3, 22, 13, 41, 26, 184, DateTimeKind.Local).AddTicks(6671), new DateTime(2023, 3, 22, 13, 41, 26, 184, DateTimeKind.Local).AddTicks(6670) });
            ...
            migrationBuilder.InsertData(
                schema: "dbo",
                table: "Users",
                columns: new[] { "Id", "Admin", "CreatedDate", "Email", "Enable", "Language", "LastAccessDate", "Login", "MedicalUserId", "ModifyDate", "Name", "PasswordHash", "PasswordSalt", "Refresh_token", "Refresh_token_expiry_time", "Role", "TimeZone" },
                values: new object[,]
                {
                    { 1L, true, new DateTime(2023, 3, 22, 13, 41, 26, 184, DateTimeKind.Local).AddTicks(7182), "admin@sistemas.com", true, null, new DateTime(2023, 3, 22, 13, 41, 26, 184, DateTimeKind.Local).AddTicks(7184), "admin", null, new DateTime(2023, 3, 22, 13, 41, 26, 184, DateTimeKind.Local).AddTicks(7186), "User MOCK ", new byte[] { 5, 6, 204, 172, 145, 156, 20, 190, 9, 84, 154, 58, 17, 135, 143, 128, 158, 230, 5, 204, 193, 88, 117, 49, 60, 222, 157, 75, 36, 3, 159, 171, 189, 183, 180, 158, 36, 69, 123, 167, 160, 40, 154, 218, 219, 48, 248, 102, 38, 25, 85, 122, 199, 67, 55, 124, 54, 113, 168, 114, 179, 138, 128, 108 }, new byte[] { 109, 196, 71, 169, 109, 93, 242, 38, 228, 43, 176, 250, 4, 188, 244, 60, 25, 77, 178, 95, 196, 21, 36, 12, 252, 28, 48, 83, 67, 109, 33, 63, 166, 170, 171, 216, 46, 158, 62, 16, 176, 79, 69, 234, 58, 22, 86, 132, 15, 230, 73, 179, 230, 232, 3, 76, 253, 66, 165, 28, 151, 78, 238, 211, 213, 187, 120, 188, 28, 53, 51, 95, 204, 129, 196, 188, 11, 184, 107, 28, 241, 114, 92, 98, 28, 125, 229, 20, 99, 222, 226, 202, 154, 54, 165, 245, 81, 31, 27, 30, 170, 49, 15, 185, 34, 161, 37, 164, 244, 213, 120, 205, 9, 112, 183, 229, 68, 19, 85, 33, 254, 201, 57, 225, 44, 87, 174, 27 }, null, null, "Admin", null },
                    { 2L, false, new DateTime(2023, 3, 22, 13, 41, 26, 184, DateTimeKind.Local).AddTicks(7551), "doctor@sistemas.com", true, null, new DateTime(2023, 3, 22, 13, 41, 26, 184, DateTimeKind.Local).AddTicks(7552), "doctor", null, new DateTime(2023, 3, 22, 13, 41, 26, 184, DateTimeKind.Local).AddTicks(7554), "User Medical", new byte[] { 196, 213, 191, 181, 251, 116, 218, 88, 225, 39, 227, 172, 119, 77, 72, 43, 48, 125, 107, 123, 15, 146, 135, 142, 92, 124, 98, 144, 0, 187, 40, 9, 54, 30, 24, 32, 162, 224, 118, 123, 128, 51, 185, 199, 230, 62, 90, 90, 226, 199, 215, 160, 14, 229, 58, 126, 79, 44, 142, 163, 253, 161, 76, 168 }, new byte[] { 50, 217, 77, 117, 216, 2, 112, 166, 34, 154, 80, 149, 71, 129, 170, 21, 39, 254, 156, 31, 168, 28, 232, 168, 75, 246, 198, 245, 86, 91, 60, 202, 74, 37, 77, 46, 135, 131, 135, 45, 120, 234, 254, 43, 100, 6, 200, 232, 130, 123, 122, 250, 167, 199, 35, 4, 234, 73, 76, 155, 176, 209, 242, 200, 224, 226, 106, 92, 3, 188, 154, 54, 167, 127, 181, 197, 59, 146, 77, 197, 171, 205, 21, 239, 81, 141, 14, 236, 45, 47, 41, 245, 42, 229, 159, 2, 20, 172, 95, 139, 52, 109, 128, 43, 208, 178, 222, 1, 150, 33, 142, 169, 66, 132, 97, 145, 232, 248, 72, 93, 74, 123, 247, 120, 49, 210, 32, 254 }, null, null, "Medical", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "123456", new DateTime(2023, 3, 22, 13, 41, 26, 184, DateTimeKind.Local).AddTicks(8022), 1L, "medical@sistemas.com", true, new DateTime(2023, 3, 22, 13, 41, 26, 184, DateTimeKind.Local).AddTicks(8024), new DateTime(2023, 3, 22, 13, 41, 26, 184, DateTimeKind.Local).AddTicks(8025), null, "Medical MOCK ", 3L, null, 0, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_MedicalUserId",
                schema: "dbo",
                table: "Users",
                column: "MedicalUserId",
                unique: true,
                filter: "[MedicalUserId] IS NOT NULL");
