...
namespace SmartDigitalPsicoWebAPI.Migrations
{
    ...
    [Migration("20230609200408_SmartDigitalPsicoDBMigv001")]
    partial class SmartDigitalPsicoDBMigv001
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartDigitalPsico.Model.Entity.Domains.Configurations.ApplicationConfigSetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2023, 6, 9, 17, 4, 8, 504, DateTimeKind.Local).AddTicks(6991),
                            Description = "Default",
                            Enable = true,
                            EndPointUrl_Cache = "",
                            EndPointUrl_StorageFiles = "",
                            Language = "pt-BR",
                            LastAccessDate = new DateTime(2023, 6, 9, 17, 4, 8, 504, DateTimeKind.Local).AddTicks(7012),
                            ModifyDate = new DateTime(2023, 6, 9, 17, 4, 8, 504, DateTimeKind.Local).AddTicks(7005),
                            TypeLocationCache = 1,
            ...
            modelBuilder.Entity("SmartDigitalPsico.Model.Entity.Domains.Configurations.ApplicationLanguage", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2023, 6, 9, 17, 4, 8, 504, DateTimeKind.Local).AddTicks(7049),
                            Description = "Default",
                            Enable = true,
                            Language = "pt-BR",
                            LanguageKey = "Default_ptbr",
                            LanguageValue = "Padrão",
                            LastAccessDate = new DateTime(2023, 6, 9, 17, 4, 8, 504, DateTimeKind.Local).AddTicks(7050),
                            ModifyDate = new DateTime(2023, 6, 9, 17, 4, 8, 504, DateTimeKind.Local).AddTicks(7049)
                        });
                });
            ...
            modelBuilder.Entity("SmartDigitalPsico.Model.Entity.Principals.Medical", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 6, 9, 17, 4, 8, 506, DateTimeKind.Local).AddTicks(8712),
                            CreatedUserId = 1L,
                            Email = "medical@sistemas.com",
                            Enable = true,
                            LastAccessDate = new DateTime(2023, 6, 9, 17, 4, 8, 506, DateTimeKind.Local).AddTicks(8714),
                            ModifyDate = new DateTime(2023, 6, 9, 17, 4, 8, 506, DateTimeKind.Local).AddTicks(8725),
                            Name = "Medical MOCK ",
                            OfficeId = 3L,
                            TypeAccreditation = 0
                        });
            ...
            modelBuilder.Entity("SmartDigitalPsico.Model.Entity.Principals.MedicalCalendar", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SmartDigitalPsico.Model.Entity.Principals.Patient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cpf = "947.846.605-42",
                            CreatedDate = new DateTime(2023, 6, 9, 17, 4, 8, 508, DateTimeKind.Local).AddTicks(8603),
                            CreatedUserId = 2L,
                            ...
                            Enable = true,
                            GenderId = 1L,
                            LastAccessDate = new DateTime(2023, 6, 9, 17, 4, 8, 508, DateTimeKind.Local).AddTicks(8606),
                            MaritalStatus = 0,
                            MedicalId = 1L,
                            ModifyDate = new DateTime(2023, 6, 9, 17, 4, 8, 508, DateTimeKind.Local).AddTicks(8606),
            ...
            modelBuilder.Entity("SmartDigitalPsico.Model.Entity.Principals.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Admin = true,
                            CreatedDate = new DateTime(2023, 6, 9, 17, 4, 8, 504, DateTimeKind.Local).AddTicks(7281),
                            Email = "admin@sistemas.com",
                            Enable = true,
                            Language = "pt-BR",
                            LastAccessDate = new DateTime(2023, 6, 9, 17, 4, 8, 504, DateTimeKind.Local).AddTicks(7281),
                            Login = "admin",
                            ModifyDate = new DateTime(2023, 6, 9, 17, 4, 8, 504, DateTimeKind.Local).AddTicks(7282),
                            Name = "User MOCK ",
                            PasswordHash = new byte[] { 10, 105, 186, 138, 61, 254, 47, 72, 36, 199, 80, 139, 173, 89, 119, 202, 81, 126, 100, 227, 242, 229, 83, 95, 22, 92, 223, 28, 78, 30, 20, 251, 235, 153, 59, 93, 210, 235, 18, 221, 39, 96, 150, 238, 199, 27, 243, 126, 201, 205, 13, 181, 64, 156, 146, 200, 122, 129, 134, 245, 251, 123, 162, 87 },
                            PasswordSalt = new byte[] { 193, 96, 132, 34, 171, 153, 156, 108, 166, 162, 245, 140, 91, 138, 143, 30, 177, 84, 62, 46, 212, 210, 162, 235, 186, 25, 161, 47, 43, 35, 86, 168, 134, 86, 164, 74, 95, 29, 178, 106, 74, 63, 127, 106, 218, 104, 91, 66, 171, 219, 10, 156, 157, 141, 67, 9, 69, 184, 172, 190, 77, 66, 170, 115, 108, 113, 229, 71, 20, 132, 15, 142, 112, 183, 224, 3, 135, 200, 10, 8, 145, 169, 27, 54, 65, 41, 188, 79, 47, 178, 138, 133, 157, 247, 189, 225, 200, 166, 129, 50, 47, 91, 47, 247, 65, 78, 20, 111, 172, 46, 237, 81, 15, 92, 90, 100, 40, 23, 164, 29, 134, 223, 119, 196, 157, 17, 128, 154 },
                            Role = "Admin",
                        ...
                        new
                        {
                            Id = 2L,
                            Admin = false,
                            CreatedDate = new DateTime(2023, 6, 9, 17, 4, 8, 506, DateTimeKind.Local).AddTicks(9027),
                            Email = "doctor@sistemas.com",
                            Enable = true,
                            Language = "pt-BR",
                            LastAccessDate = new DateTime(2023, 6, 9, 17, 4, 8, 506, DateTimeKind.Local).AddTicks(9029),
                            Login = "doctor",
                            MedicalId = 1L,
                            ModifyDate = new DateTime(2023, 6, 9, 17, 4, 8, 506, DateTimeKind.Local).AddTicks(9029),
                            Name = "User Medical",
                            PasswordHash = new byte[] { 93, 241, 192, 18, 53, 245, 80, 179, 125, 141, 180, 14, 162, 26, 10, 145, 199, 195, 174, 72, 183, 206, 88, 117, 198, 104, 205, 18, 154, 167, 15, 14, 20, 71, 5, 94, 242, 94, 103, 47, 121, 45, 200, 147, 3, 211, 145, 206, 157, 178, 87, 122, 24, 209, 141, 181, 21, 108, 205, 135, 169, 104, 127, 78 },
                            PasswordSalt = new byte[] { 137, 28, 22, 244, 168, 1, 80, 224, 248, 3, 223, 72, 43, 93, 84, 18, 193, 4, 18, 36, 82, 204, 17, 67, 129, 75, 65, 162, 227, 102, 251, 135, 57, 95, 187, 89, 141, 230, 209, 245, 148, 107, 253, 185, 216, 146, 230, 49, 96, 183, 84, 115, 118, 185, 140, 29, 139, 217, 217, 27, 48, 84, 166, 221, 212, 57, 244, 193, 242, 186, 251, 122, 67, 141, 48, 175, 57, 109, 247, 246, 50, 88, 169, 239, 146, 207, 193, 162, 241, 100, 174, 253, 93, 100, 16, 139, 136, 72, 102, 55, 104, 199, 237, 8, 154, 135, 114, 242, 210, 223, 22, 120, 1, 72, 171, 30, 241, 85, 124, 239, 75, 60, 49, 240, 172, 94, 162, 199 },
                            Role = "Medical",
                            TimeZone = "E. South America Standard Time"
                        });
                });
