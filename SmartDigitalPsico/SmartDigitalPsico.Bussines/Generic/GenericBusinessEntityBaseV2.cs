...
{
    public class GenericBusinessEntityBaseV2<TEntity, TEntityAdd, TEntityUpdate, TEntityResult, Repo>
        : IGenericBusinessEntityBaseV2<TEntity, TEntityAdd, TEntityUpdate, TEntityResult>
...

    {
        ...
        public GenericBusinessEntityBaseV2(IMapper mapper, Repo UserRepository)
        {
            _mapper = mapper;
