    ...
    public partial class SmartDigitalPsicoDBMig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2023, 3, 23, 16, 38, 57, 8, DateTimeKind.Local).AddTicks(9910), "Default", true, "", "", "pt-BR", new DateTime(2023, 3, 23, 16, 38, 57, 8, DateTimeKind.Local).AddTicks(9929), new DateTime(2023, 3, 23, 16, 38, 57, 8, DateTimeKind.Local).AddTicks(9926), 1, 0, 0 });

            migrationBuilder.InsertData(
                schema: "dbo",
                table: "ApplicationLanguage",
                columns: new[] { "Id", "CreatedDate", "Description", "Enable", "Language", "LanguageKey", "LanguageValue", "LastAccessDate", "ModifyDate" },
                values: new object[] { 1L, new DateTime(2023, 3, 23, 16, 38, 57, 9, DateTimeKind.Local).AddTicks(28), "Default", true, "pt-BR", "Default_ptbr", "Padrão", new DateTime(2023, 3, 23, 16, 38, 57, 9, DateTimeKind.Local).AddTicks(32), new DateTime(2023, 3, 23, 16, 38, 57, 9, DateTimeKind.Local).AddTicks(31) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "123456", new DateTime(2023, 3, 23, 16, 38, 57, 9, DateTimeKind.Local).AddTicks(1060), 1L, "medical@sistemas.com", true, new DateTime(2023, 3, 23, 16, 38, 57, 9, DateTimeKind.Local).AddTicks(1062), new DateTime(2023, 3, 23, 16, 38, 57, 9, DateTimeKind.Local).AddTicks(1064), null, "Medical MOCK ", 3L, null, 0, null });
