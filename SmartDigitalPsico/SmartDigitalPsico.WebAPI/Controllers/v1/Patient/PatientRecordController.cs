...
namespace SmartDigitalPsico.WebAPI.Controllers.v1.Patient
{
    ...
    {
        private readonly IPatientRecordServices _entityService;

        public PatientRecordController(IPatientRecordServices entityService, IOptions<AuthConfigurationVO> configurationAuth) : base(configurationAuth)
        {
