        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Education = table.Column<string>(type: "varchar(255)", nullable: true),
                    PhoneNumber = table.Column<string>(type: "varchar(20)", nullable: true),
                    AddressStreet = table.Column<string>(type: "varchar(255)", nullable: true),
                    AddressNeighborhood = table.Column<string>(type: "varchar(255)", nullable: true),
                    AddressCity = table.Column<string>(type: "varchar(255)", nullable: true),
                    AddressState = table.Column<string>(type: "varchar(255)", nullable: true),
                    AddressCep = table.Column<string>(type: "varchar(20)", nullable: true),
                    EmergencyContactName = table.Column<string>(type: "varchar(255)", nullable: true),
                    EmergencyContactPhoneNumber = table.Column<string>(type: "varchar(20)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifyDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastAccessDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Dosage = table.Column<string>(type: "varchar(255)", nullable: true),
                    Posology = table.Column<string>(type: "varchar(255)", nullable: true),
                    MainDrug = table.Column<string>(type: "varchar(255)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifyDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastAccessDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
